...
/* harmony import */ var _modules_showLabels__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/showLabels */ "./src/js/modules/showLabels.js");
/* harmony import */ var _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/slider/slider_main */ "./src/js/modules/slider/slider_main.js");
/* harmony import */ var _modules_slider_slider_mini__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./modules/slider/slider_mini */ "./src/js/modules/slider/slider_mini.js");
...
window.addEventListener('DOMContentLoaded', function () {
  var sliderIndex = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_5__["default"]({
    container: '.page',
    btns: '.next'
  }).render();
  var sliderModules = new _modules_slider_slider_main__WEBPACK_IMPORTED_MODULE_5__["default"]({
    container: '.moduleapp',
    btns: '.sidecontrol__controls .next',
    prevs: '.module__info-controls .prev',
    nexts: '.module__info-controls .next'
  }).render();
  ...
  var player = new _modules_playVideo__WEBPACK_IMPORTED_MODULE_3__["default"]('.showup .play', '.overlay').init();
  var oldEdu = new _modules_showLabels__WEBPACK_IMPORTED_MODULE_4__["default"]('.officerold').init();
  var newEdu = new _modules_showLabels__WEBPACK_IMPORTED_MODULE_4__["default"]('.officernew').init();
  var forms = new _modules_form__WEBPACK_IMPORTED_MODULE_2__["default"]().init();
  var accord = new _modules_accordion__WEBPACK_IMPORTED_MODULE_0__["default"]('.module__info-show').init();
...
function () {
  function Accordion() {
    var triggers = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : null;
    ...
    value: function init() {
      ...
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          _this.downloadItem(btn.getAttribute('data-download'));
        });
      });
    }
  }]);
...
function () {
  ...
  _createClass(Forms, [{
    key: "blockCyr",
    value: function blockCyr() {
      this.ruBlocks.forEach(function (item) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return LabelShow; });
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! core-js/modules/web.dom-collections.for-each */ "./node_modules/core-js/modules/web.dom-collections.for-each.js");
/* harmony import */ var core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(core_js_modules_web_dom_collections_for_each__WEBPACK_IMPORTED_MODULE_0__);
...
/*#__PURE__*/
function () {
  function LabelShow(parent) {
    _classCallCheck(this, LabelShow);

    this.parent = document.querySelector(parent);
    this.labels = document.querySelectorAll("".concat(parent, " .hide-item"));
  ...
  _createClass(LabelShow, [{
    key: "addItem",
    value: function addItem() {
      var _this = this;

      this.btn.addEventListener('click', function () {
        _this.labels[_this.checkIndex].style.display = 'flex';

        _this.labels[_this.checkIndex].classList.add('fadeInDown');

        _this.checkIndex++;

        if (_this.checkIndex === _this.labels.length) {
          _this.btn.remove();
        }
      });
    }
    ...
    value: function init() {
      ...
      try {
        this.labels.forEach(function (item) {
          ...
          _this2.labels[_this2.checkIndex].classList.remove('fadeInDown');
        });
        this.addItem();
      } catch (error) {}
    }
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$prevs = _ref.prevs,
      prevs = _ref$prevs === void 0 ? null : _ref$prevs,
      _ref$nexts = _ref.nexts,
      nexts = _ref$nexts === void 0 ? null : _ref$nexts,
...
/***/ "./src/js/modules/slider/slider_main.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slider/slider_main.js ***!
  \**********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function MainSlider(container, btns, prevs, nexts) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, container, btns, prevs, nexts));
  }
  ...
  _createClass(MainSlider, [{
    ...
    key: "clickingOn",
    value: function clickingOn(trigger, value) {
      var _this2 = this;

      trigger.addEventListener('click', function (e) {
        console.log(e.target);

        _this2.plusSlide(value);
      });
      trigger.parentElement.previousElementSibling.addEventListener('click', function (e) {
    ...
    value: function render() {
      ...
      try {
        ...
        this.btns.forEach(function (btn) {
          _this3.clickingOn(btn, 1);
        });
        this.prevs.forEach(function (prev) {
          _this3.clickingOn(prev, -1);
        });
        this.nexts.forEach(function (next) {
          _this3.clickingOn(next, 1);
        });
...
/***/ "./src/js/modules/slider/slider_mini.js":
/*!**********************************************!*\
  !*** ./src/js/modules/slider/slider_mini.js ***!
  \**********************************************/
/*! exports provided: default */
...
function (_Slider) {
  ...
  function SliderMini(container, prev, next, activeClass, autoplay) {
    _classCallCheck(this, SliderMini);

    return _possibleConstructorReturn(this, _getPrototypeOf(SliderMini).call(this, container, prev, next, activeClass, autoplay));
  }
    ...
    value: function removeBtns() {
      ...
      this.slides.forEach(function (slide, i) {
        if (slide.nodeName === "BUTTON") {
          _this2.slides.splice(i, 1);
        }
      });
    }
  }, {
    key: "inTime",
    value: function inTime() {
